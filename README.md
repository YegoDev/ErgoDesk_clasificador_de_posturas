...
Los scrips acá detallados, soportan el EDA y preprocesmaiento de imagenes de posturas en escritorios de trabajo. Así mismo: 
- La carpeta modelo_mediapipe: contiene los scripts para extraer features con media pipe de las iamgenes de entrenamiento, entrenar 3 modelos de clasificación como son Randon Forest, regresión logística y un script de validación.
